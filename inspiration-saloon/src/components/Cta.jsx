...
export default function Cta() {
  ...
  <div className="mt-6">
    <a
      ...
      className="inline-block rounded-md bg-white text-gray-900 px-5 py-3 font-medium hover:bg-brand hover:text-white transition"
    >
      Call Now
    </a>
  </div>
            ...
            <div className=" text-gray-900 rounded-xl p-4 md:p-6">
